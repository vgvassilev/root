...
namespace ROOT {
   namespace Benchmark {
      ...
      class TypeSize {
         template <typename C>
         static constexpr size_t Get( decltype(&C::Size) ) { return C::Size; }
         template <typename C>
         static constexpr size_t Get(typename std::enable_if<std::is_arithmetic<C>::value>::type* = 0) { return 1; }
      ...
      struct VecTraits {
         ...
         bool is_aligned(const void *__restrict__ ptr, size_t align)
         {
